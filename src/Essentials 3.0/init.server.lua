...
local Configuration = {
    ...
    ['Datastore Key'] = ('BAE3.0_#$DGF'), -- What cape data, ban data, etc. is stored under. Changing will wipe it.
    ['Webhook Logs'] = false, -- Use webhook logs? HttpService must be enabled.
...
require(script:FindFirstChild('Module'))(Plugins,Configuration)